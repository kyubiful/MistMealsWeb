...
class Helper
{
  ...
  public static function calculateDishes($caloriasDiariasTotales)
  {
    ...
    if ($caloriasDiariasTotales > 1851) {
      $dishes = Plato::where('codigo', 'like', '%2B%', 'AND', 'active', '=', 1)->get();
      $lunchDishes = $dishes;
      $dinnerDishes = $dishes;
    ...
    if ($caloriasDiariasTotales > 1551 and $caloriasDiariasTotales < 1850) {
      $dinnerDishes = Plato::where('codigo', 'like', '%1B%', 'AND', 'active', '=', 1)->get();
      $lunchDishes = Plato::where('codigo', 'like', '%2B%', 'AND', 'active', '=', 1)->get();
    ...
    if ($caloriasDiariasTotales > 1400 and $caloriasDiariasTotales < 1550) {
      $dinnerDishes = Plato::where('codigo', 'like', '%1A%', 'AND', 'active', '=', 1)->get();
      $lunchDishes = Plato::where('codigo', 'like', '%2B%', 'AND', 'active', '=', 1)->get();
    ...
    if ($caloriasDiariasTotales < 1399) {
      $dinnerDishes = Plato::where('codigo', 'like', '%2A%', 'AND', 'active', '=', 1)->get();
      $lunchDishes = Plato::where('codigo', 'like', '%1B%', 'AND', 'active', '=', 1)->get();
