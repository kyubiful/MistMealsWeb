    ...
    public function PDFEtiqueta(Request $request) 
    {
        ...
        if($valor == 'M'){
            ...
            $datosPlato = [
                ...
                'receta' => $plato->receta,
                'peso' => 350,
                'energia' => $plato_info_nutricional->energia,
                ...
                'energia_cien' => round(($plato_info_nutricional->energia*100)/350, 2),
            ...
            $datosPlato = [
                ...
                'sales' => $plato_info_nutricional->sodio,
                'fibra' => $plato_info_nutricional->fibra,
                'energia_cien' => round(($plato_info_nutricional->energia*100)/560, 2),
