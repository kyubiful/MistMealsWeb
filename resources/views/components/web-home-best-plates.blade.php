...
<section>
  ...
  <div class="web-home-best-plate-container">
    <div class="web-home-best-plate-content">
      ...
      <div style="padding: 16px;">
        <x-global-plates-plate :plato="$platos[2]"/>
        <x-global-plates-plate class="hidden" style="margin-top: -519px;" :plato="$platos[3]"/>
      </div>
      <div style="padding: 16px;">
        <x-global-plates-plate :plato="$platos[4]"/>
        <x-global-plates-plate class="hidden" style="margin-top: -519px;" :plato="$platos[5]"/>
      </div>
    </div>
  </div>
</section>
