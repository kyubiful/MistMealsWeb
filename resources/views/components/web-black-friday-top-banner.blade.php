@once
@push('css')
  <link rel="stylesheet" href="{{asset('/css/blackfriday/web-black-friday-top-banner.css')}}" />
@endpush
@endonce

<section class="web-blackfriday-top-banner-container">
  <img class="mp-mobile-hidden top-plates-image" src="/img/blackfriday/Platos.png"/>
  ...
  <img class="promo-img" src="/img/blackfriday/PromoBlackFriday.png"/>
</section>
