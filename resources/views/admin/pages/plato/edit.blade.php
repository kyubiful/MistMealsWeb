          ...
          <div class="card-body">
            <div class="row form-group">
              <div class="col-sm-12" style="display: flex; justify-content: flex-start; align-items: center;">
                  <input class="form-check-input" type="checkbox" name="active" id="plate_active" style="position:static; margin-left: 0px; margin-top: 0px;" {{ $plato->active == 1 ? 'checked' : ''}}>
            ...
            <div class="row form-group">
              ...
              <div class="col-sm-4">
                  <div class="form-group">
                      ...
                      {!! Form::number('peso', $plato->peso , ['id' => 'peso', 'class' => 'form-control', 'placeholder' => 'peso', 'min' => 0, 'step' => '0.01', 'required']) !!}
                  </div>
              </div><!-- Col -->
              <div class="col-sm-3">
                <div class="form-group">
